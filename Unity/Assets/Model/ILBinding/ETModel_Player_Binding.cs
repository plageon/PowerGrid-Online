...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Player_Binding
    {
        ...
        static StackObject* set_UnitId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.IsReady = false;
            instance_of_this_method.IsPassed = false;
            instance_of_this_method.HasBought = false;
            instance_of_this_method.OwnPlants = new Dictionary<int,string>();
